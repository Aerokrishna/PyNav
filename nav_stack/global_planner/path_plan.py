...
class PlanGlobalPath(Node):
    def __init__(self):
        ...
        self.path_timer_ = self.create_timer(3.0, self.publish_path)
        ...
        self.path_pub_timer = self.create_timer(3.0, self.compute_path)
    ...
    def compute_path(self):
        ...
        if self.occupancy_grid is not None:
            initial_pose = (self.initial_pose/self.res).astype("int32")
