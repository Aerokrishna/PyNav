...
def a_star(start_node, goal_node, occupancyGrid):
    ...
    # node_x, node_y = np.unravel_index(start_node, occupancyGrid.shape)
    # if not is_valid(node_x,node_y,occupancyGrid,closed_nodes):
    #     print("initial position is NOT VALID! No path found")
    #     return []
    
    # node_x, node_y = np.unravel_index(goal_node, occupancyGrid.shape)
    # if not is_valid(node_x,node_y,occupancyGrid,closed_nodes):
    #     print("goal position is NOT VALID! No path found") 
    #     return []
